  ...
  return <section className="py-16 lg:py-24">
      <div className="container mx-auto px-6">
        <div className="bg-card rounded-3xl p-8 lg:p-16 shadow-medium text-center max-w-4xl mx-auto">
          ...
          <Link to="/become-local" className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-primary text-primary-foreground font-semibold hover:opacity-90 transition-opacity group">
