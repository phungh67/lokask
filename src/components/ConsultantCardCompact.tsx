  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center px-4 pb-5 -mt-10 relative">
        ...
        {/* Name */}
        <h3 className="font-bold text-[18px] text-foreground leading-tight font-display">
          {consultant.name}
        </h3>
        ...
        {/* Tag Pill */}
        <span 
          className="inline-block px-3 py-1.5 text-[12px] font-medium rounded-full mb-3 transition-colors"
          style={{ 
