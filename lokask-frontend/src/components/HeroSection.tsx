...
const slides = [
  {
    video:
      "https://videos.pexels.com/video-files/3015488/3015488-uhd_2560_1440_24fps.mp4",
  ...
  {
    video:
      "https://videos.pexels.com/video-files/1721294/1721294-uhd_2560_1440_25fps.mp4",
    poster: heroDesertPoster,
    location: "Amalfi Coast, Italy",
    description:
      "Where cliffside villages cascade down to the sparkling Mediterranean.",
  },
  {
    video:
    ...
    description:
      "Ancient temples whisper stories among bamboo groves and cherry blossoms.",
  },
  {
    video:
      ...
      <div className="flex flex-col lg:flex-row min-h-[calc(100vh-64px)]">
        ...
        <div className="lg:w-[58%] px-6 lg:pl-12 lg:pr-8 xl:pr-16 py-8 lg:py-12 flex flex-col justify-center">
          ...
          <p className="text-lg lg:text-xl text-muted-foreground mb-8 max-w-xl leading-relaxed">
            Find real people who live there and get honest advice before your
            trip.
          </p>
